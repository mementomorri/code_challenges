...
if __name__ == "__main__":
    ...
    print(
        "search_for_primes(10000000, 100000000):",
        search_for_primes((10000000, 100000000)),
    )
    print(
        "search_for_primes(100000000000000, 1000000000000000):",
        search_for_primes((100000000000000, 1000000000000000)),
    )
    print(
        "search_for_primes(10000000000000000000, 100000000000000000000):",
        search_for_primes((10000000000000000000, 100000000000000000000)),
    )

    # The time to test primes near 1,000,000 using fast_is_prime is about 4 ms,
    # 4 times the time needed to test primes near 1,000.
    # This is faster compared to 8 ms that we achieved if we use the is_prime.
    # However, despite being 4 times slower,
    # this fact cannot lead us to believe that it has a greater growth than Θ(logn),
    # as it should be tested with greater numbers to gain a more accurate understanding
